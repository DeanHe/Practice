...
public class TheMostSimilarPathInaGraphTest {
    private TheMostSimilarPathInaGraph tm;

    @Before
    public void setup() {
        tm = new TheMostSimilarPathInaGraph();
    }
    ...
    public void testCase1() {
        ...
        List<Integer> res = tm.mostSimilar(n, roads, names, targetPath);
    ...
    public void testCase2() {
        int n = 4;
        int[][] roads = {{1, 0}, {2, 0}, {3, 0}, {2, 1}, {3, 1}, {3, 2}};
