...
class SumGame:
    def sumGame(self, num: str) -> bool:
        ...
        left_total, left_que = get(num[:len(num) // 2])
        right_total, right_que = get(num[len(num) // 2:])

        return (left_que + right_que) % 2 == 1 or left_total - right_total != (right_que - left_que) * 9 // 2