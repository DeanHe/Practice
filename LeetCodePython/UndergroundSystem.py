...
class UndergroundSystem:
    ...
    def __init__(self):
        self.check_in, self.check_out = {}, collections.defaultdict(lambda: (0, 0))
    ...
    def checkOut(self, id: int, stationName: str, t: int) -> None:
        ...
        total_time = t - start_t
        existing_total_time, existing_cnt = self.check_out[route]
        self.check_out[route] = (total_time + existing_total_time, existing_cnt + 1)


    def getAverageTime(self, startStation: str, endStation: str) -> float:
        route = startStation + "_" + endStation
        total_time, cnt = self.check_out[route]
