...
he total cost is thus 2 + 1 + 2 + 1 = 6, which is the minimum possible total cost.
...
class MinimumCostToPartitionaBinaryString:
    def minCost(self, s: str, encCost: int, flatCost: int) -> int:
        ...
        def dfs(l, r):
            length = r - l + 1
            one_cnt = pre_sum[r + 1] - pre_sum[l]
            res = flatCost
            if one_cnt > 0:
                res = one_cnt * length * encCost
            if length % 2 == 0:
                mid = (l + r) // 2
