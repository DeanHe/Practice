...
class EarliestFinishTimeForLandAndWaterRidesII:
    def earliestFinishTime(self, landStartTime: List[int], landDuration: List[int], waterStartTime: List[int], waterDuration: List[int]) -> int:
        ...
        land_water_cost = solve(landStartTime, landDuration, waterStartTime, waterDuration)
        water_land_cost = solve(waterStartTime, waterDuration, landStartTime, landDuration)
        return min(land_water_cost, water_land_cost)